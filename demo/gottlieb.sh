...
# $train -f 10 -l2 0.01 -k 32 -p $HOME/Documents/Mangaki/mugen_test.csv $HOME/Documents/Mangaki/mugen_train.csv ocmf_model.txt
$train -f 10 -l2 0.01 -k 32 -p $HOME/code/cfdr/code/gottlieb_test.csv $HOME/code/cfdr/code/gottlieb_train.csv ocmf_model.txt
# Do prediction and show row-oriented MPR
$predict -e 10 $HOME/code/cfdr/code/gottlieb_test.csv ocmf_model.txt ocmf_output.txt
# Do prediction and show row-oriented AUC
$predict -e 12 $HOME/code/cfdr/code/gottlieb_test.csv ocmf_model.txt ocmf_output.txt

echo "----------------------------------------------------------------"
echo "one-class matrix factorization using a coordinate descent method"
echo "----------------------------------------------------------------"
# In-memory training with holdout validation
$train -f 12 -l2 0.01 -k 32 -a 0.001 -c 0.0001 -p $HOME/code/cfdr/code/gottlieb_test.csv $HOME/code/cfdr/code/gottlieb_train.csv ocmf_model.txt
# Do prediction and show row-oriented MPR
$predict -e 10 $HOME/code/cfdr/code/gottlieb_test.csv ocmf_model.txt ocmf_output2.txt
# Do prediction and show row-oriented AUC
$predict -e 12 $HOME/code/cfdr/code/gottlieb_test.csv ocmf_model.txt ocmf_output2.txt
